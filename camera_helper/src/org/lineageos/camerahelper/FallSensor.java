    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        new Handler(Looper.getMainLooper()).post(() -> {
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(mContext)
                    .setTitle(res.getString(R.string.fall_detected_title))
                    .setMessage(res.getString(R.string.fall_detected_message))
                    .setPositiveButton(res.getString(R.string.fall_detected_button),
                            (dialog, which) -> {
                        // Reopen the camera
